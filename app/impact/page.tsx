...
export default function ImpactPage() {
  ...
  const impactProfiles = [
    { title: "Founder", desc: "E-commerce Brand", image: "/owner.jpg" },
    { title: "Creative Director", desc: "Design Agency", image: "/owner.jpg" },
    { title: "Investor", desc: "Portfolio Builder", image: "/owner.jpg" },
    { title: "AI Entrepreneur", desc: "SaaS Founder", image: "/owner.jpg" }
  ];
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", gap: "22px", fontSize: "10px", fontWeight: "400", letterSpacing: "1.5px", color: "#8e8e93", fontFamily: "sans-serif" }} className="hidden xl:flex items-center">
          ...
          <a href="/impact" style={{ color: "#C5A059", textDecoration: "none" }}>Impact</a>
      ...
      {isMobileMenuOpen && (
        <div style={{
          ...
          <a href="/impact" onClick={() => setIsMobileMenuOpen(false)} style={{ fontSize: "13px", letterSpacing: "2px", color: "#C5A059", textDecoration: "none" }}>Impact</a>
      ...
      {/* IMPACT & RESULTS SECTION (EXACT REFERENCE MATCH) */}
      <section style={{
        minHeight: "100vh",
        display: "flex",
        flexDirection: "column",
        ...
        >
          ...
          <p style={{ color: "#a1a1a6", fontSize: "15px", lineHeight: "1.8", letterSpacing: "0.5px", margin: 0, fontFamily: "sans-serif", maxWidth: "450px" }}>
            They came as individuals.<br />
            They became impact creators.
          </p>
        </motion.div>
        ...
        <div style={{
          ...
          {impactProfiles.map((profile, idx) => (
            <div key={idx} style={{
              position: "relative",
              aspectRatio: "3/4",
              ...
              <div style={{
                ...
                zIndex: 2,
                padding: "24px 20px",
                background: "linear-gradient(180deg, transparent 0%, rgba(13,14,17,0.95) 100%)",
                fontFamily: "sans-serif",
                textAlign: "center"
              }}>
                <div style={{ fontSize: "14px", fontWeight: "600", color: "#f9f9fb", letterSpacing: "1px", marginBottom: "4px" }}>{profile.title}</div>
                <div style={{ fontSize: "11px", color: "#C5A059", letterSpacing: "1.5px" }}>{profile.desc}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <footer style={{ 
        ...
        <div style={{ display: "flex", gap: "60px", flexWrap: "wrap", fontSize: "11px", letterSpacing: "2px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <a href="/impact" style={{ color: "#8e8e93", textDecoration: "none" }}>Impact</a>
