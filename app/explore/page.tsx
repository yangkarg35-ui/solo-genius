...
export default function ExplorePage() {
  ...
  return (
    <div style={{
      ...
      {/* INTRO SECTION WITH OWNER BACKGROUND PHOTO */}
      <section style={{ 
        position: "relative",
        maxWidth: "100%", 
        margin: "0 auto", 
        ...
        textAlign: "center",
        backgroundImage: "linear-gradient(rgba(13, 14, 17, 0.85), rgba(13, 14, 17, 0.92)), url('/owner.jpg')",
        backgroundSize: "cover",
        backgroundPosition: "center",
        backgroundRepeat: "no-repeat"
      }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "24px", position: "relative", zIndex: 2 }}>
          <span style={{ color: "#C5A059", textTransform: "uppercase", fontSize: "10px", letterSpacing: "4px", fontWeight: "600", fontFamily: "sans-serif" }}>
            INTRO
          </span>
      ...
      <section style={{ maxWidth: "1280px", margin: "0 auto", padding: "140px 24px", boxSizing: "border-box", borderTop: "1px solid rgba(197,160,89,0.08)" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "32px" }}>
          <div style={{ backgroundColor: "rgba(20, 21, 26, 0.6)", border: "1px solid rgba(197, 160, 89, 0.12)", padding: "50px 40px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
