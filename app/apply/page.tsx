                ...
                {currentStep === 7 && (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div>
                          Applicant: <strong style={{ color: '#FFFFFF' }}>{formData.fullName || '-'}</strong>
                        </div>
                        <div>
                          Contact: <strong style={{ color: '#FFFFFF' }}>{formData.email || '-'}</strong>
                        </div>
                        <div>
                          Location: <strong style={{ color: '#FFFFFF' }}>{formData.city || '-'}</strong>
                        </div>
                        <div>
